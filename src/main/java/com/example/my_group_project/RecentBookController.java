        ...
        try (Connection connection = DatabaseConnection.getConnection();
            ...
            while (resultSet.next()) {
                Book newBook = new Book(resultSet.getString("book_ID"), resultSet.getString("title"),
                        resultSet.getString("author"),resultSet.getString("image"),  resultSet.getString("description"), resultSet.getString("gerne"),
                        resultSet.getInt("viewCount"),resultSet.getInt("number_of_borrows"));
